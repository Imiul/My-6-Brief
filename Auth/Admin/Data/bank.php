...
<div class="min-h-full">
        ...
        <section class="mt-20 mx-auto max-w-7xl py-6 sm:px-6 lg:px-8" >
            <form action="bank.php" placeholder class="grid gap-4 grid-cols-2 border-b-4 border-gray-600 pb-4" name="bank_form">
                ...
                <button type="submit" class="bg-gray-600 text-white text-xl rounded">Add Bank</button>
            </form>
        </section>
                        ...
                        <tbody>
                            <tr class="border-b dark:border-neutral-500">
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <img src="../../../Assets/Img/cih-bank.svg" alt="bank logo" width="150px">
                                </td>
