...
<div class="min-h-full">
        ...
        <section id="add" class="mt-20 mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 " >
            ...
            <form action="Transactions.php" placeholder class="grid gap-4 grid-cols-2 border-b-4 border-gray-600 pb-4">
                <select name="AccountId" class="pl-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6">
                    <option value="1">Choose Account to Add Account </option>
                ...
                <button type="submit" class="bg-gray-600 text-white text-xl rounded">Add Transaction</button>
            </form>
        </section>
                    ...
                    <div class="overflow-hidden">
                        ...
                        <tbody>
                            <tr class="border-b dark:border-neutral-500">
                                ...
                                <td class="whitespace-nowrap px-6 py-4">credit</td>
